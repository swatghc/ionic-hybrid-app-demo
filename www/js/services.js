...
app.factory('User', function ($http, SERVER, $q, $localstorage) {
    ...
    //check if thers's a user session present
...
app.factory('Recommendations', function ($http, SERVER, $q) {
    var media;
    var o = {
        queue: []
    };
    ...
    o.playCurrentSong = function () {
        //a Deferred object which represents a task which will finish in the future.
        var defer = $q.defer();
